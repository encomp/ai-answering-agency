# Validation Campaign: Phoenix — First 50 Leads

## Goal
Prove garage door repair owners in Phoenix will respond to a remote AI answering service offer well enough to book a free 14-day pilot.
...
- **Geography**: Phoenix–Mesa–Chandler–Scottsdale metro
- **Firm size**: 1–5 trucks, owner-operated
- **Signal**: Google Maps listing, active reviews, has a phone number on listing
- **Exclude**: large franchises, supply-only stores, inactive listings
...
**Tool**: Outscraper
**Query**: `garage door repair` in Phoenix, Mesa, Chandler, Scottsdale, Glendale
...
2. Keep only rows with US phone numbers
...
- **Local networking / supplier intros** (tertiary) — 10 touches if available
...
> Hi [First Name],
>
> I'm reaching out remotely and came across [Company Name] on Google Maps. Looks like you've been in business for a while in Phoenix.
>
...
>
> With summer temps hitting 110°F+, after-hours door emergencies spike. I figured a shop like yours might be missing calls when you're on a late job or when the office is closed.
>
...
>
> I made a 45-second recording of the AI answering a fake after-hours garage door call. The caller says the door won't open and they need to leave for work in 10 minutes. The AI collects name, address, and callback timing.
>
...
> Quick question for garage door owners in Phoenix:
>
> How many calls go to voicemail after 6 PM, especially in summer when a broken door means the car's stuck inside in 110° heat?
>
...
Create a Google Sheet named `Phoenix Validation Campaign Tracker` with these columns:
...
| Day | Action |
|---|---|
| 1 | Run Outscraper query for Phoenix metro; export CSV |
| 1 | Clean + randomize; keep top 50 |
| 2–3 | Send first-touch emails in two batches (25 each) |
| 4–5 | Post in 3–5 local contractor Facebook / Instagram groups |
...
- Use a Phoenix local number when provisioning voice pilots.
